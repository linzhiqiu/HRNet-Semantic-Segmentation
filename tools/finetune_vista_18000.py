...
def main():
    ...
    final_output_dir = os.path.join(final_output_dir, f'9000_finetune_on_{mode}_second_run')
    ...
    if mode == 'half_0':
        list_path = 'data/list/vista_v2_0_18000/train_half_0.lst'
        end_epoch = config.TRAIN.END_EPOCH
    elif mode == 'half_1':
        list_path = 'data/list/vista_v2_0_18000/train_half_1.lst'
        end_epoch = config.TRAIN.END_EPOCH
    elif mode == 'upper':
        list_path = 'data/list/vista_v2_0_18000/train.lst'
