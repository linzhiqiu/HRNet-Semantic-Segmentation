...
def main():
    ...
    final_output_dir = os.path.join(final_output_dir, f'selftrain_{args.strategy}')
    ...
    list_path = f'data/list/vista_v2_0_10000/train_half_1_selftrain_{args.strategy}.lst'
